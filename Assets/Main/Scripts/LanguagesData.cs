...
public class LanguagesData : MonoBehaviour
{
    ...
    [HideInInspector] public string heartText;
    [HideInInspector] public string placeHolderText;
    ...
    public Image noInternetPanel;
    public Image noInternetBtn;
    ...
    public string placeholder_tkm;
    public string loadingPanelText_tkm;
    ...
    public Sprite leaderboardIcon_tkm;
    ...
    public Sprite noInternetPanel_tkm;
    public Sprite noInternetBtn_tkm;
    ...
    public string placeholder_eng;
    public string loadingPanelText_eng;
    ...
    public Sprite leaderboardIcon_eng;
    ...
    public Sprite noInternetPanel_eng;
    public Sprite noInternetBtn_eng;
    ...
    public string placeholder_rus;
    public string loadingPanelText_rus;
    ...
    public Sprite leaderboardIcon_rus;
    ...
    public Sprite noInternetPanel_rus;
    public Sprite noInternetBtn_rus;
